...
if(!trait_exists($PDOCVE) || !trait_exists($PERCVE) || !trait_exists($PERAPE) || !trait_exists($PERNOM) || !trait_exists($ACTCVE) 
    || !trait_exists($OTRLUG) || !trait_exists($LUNHRA) || !trait_exists($MARHRA) || !trait_exists($MIEHRA) || !trait_exists($JUEHRA) 
    || !trait_exists($VIEHRA) || !trait_exists($SABHRA) || !trait_exists($DOMHRA) ){
    $host = "192.168.51.40";
    $dbusername = "dbadmin";
    ...
    if(mysqli_connect_error()){
        ...
        $sql=mysqli_query($conn, "SELECT* FROM administrativos");
